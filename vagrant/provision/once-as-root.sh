...
info "Use additional repository to install PHP 7+ on Ubuntu 16.04"
...
mysql -uroot <<< "CREATE DATABASE yii2advanced character set utf8mb4 collate utf8mb4_unicode_ci"
mysql -uroot <<< "CREATE DATABASE yii2advanced_test character set utf8mb4 collate utf8mb4_unicode_ci"
echo "Done!"
